...
import com.zihan.blog.core.business.entity.Tags;
...
import com.zihan.blog.core.business.util.ImageDownloadUtil;
import com.zihan.blog.core.framework.exception.ZhydException;
import com.zihan.blog.core.util.SessionUtil;
import com.zihan.blog.spider.model.Article;
import com.zihan.blog.spider.model.BaseModel;
import com.zihan.blog.spider.processor.ArticleSpiderProcessor;
import com.zihan.blog.spider.processor.BaseSpider;
import com.zihan.blog.spider.util.WriterUtil;
import com.zihan.blog.spider.webmagic.ZhydSpider;
...
//        List<Tags> tags = tagsService.listAll();
        ...
        // 添加文章到数据库
        com.zihan.blog.core.business.entity.Article article = null;
        // 处理标签，并获取最终待添加的标签id
        ...
        for (Article spiderArticle : list) {
            ...
            article = new com.zihan.blog.core.business.entity.Article();
